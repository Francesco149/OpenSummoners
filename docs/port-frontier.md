...
- frontier functions: **216**
- of those, zero-dependency **leaves: 122** (recommended order below)
...
### master dialogue runner + action/frame dispatch + sprite batch (2)
...
### tile/sprite grid render + spell fx + battle UI + palette (16)
