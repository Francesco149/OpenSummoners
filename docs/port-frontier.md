...
- frontier functions: **151**
- of those, zero-dependency **leaves: 87** (recommended order below)
...
### menu/dialog controller + char init + shop/NPC + save path (22)
...
### title + gameplay scene runners + engine init + options + input init (35)
