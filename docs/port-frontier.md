...
- frontier functions: **199**
- of those, zero-dependency **leaves: 111** (recommended order below)
...
### object-pool ctor + game-loop FSM + font/glyph + msg fmt (18)
...
### title + gameplay scene runners + engine init + options + input init (42)
