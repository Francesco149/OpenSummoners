...
```
██░░░░░░░░░░░░░░░░░░  11.1% touched   (11.1% host-tested, 12.0% of code bytes)
```

| status      | count | what it means                                          |
|-------------|------:|--------------------------------------------------------|
| tested      |   173 | ported + module covered by the host unit suite       |
| ported      |     5 | reimplemented in src/, no host test for that module  |
| **touched** | **178** | tested + ported (FUN_ provenance ref in src/)    |
| unported    |  1580 | exists in engine, never referenced from src/         |
...
Code-byte coverage (12.0% of engine-proper bytes) is the truer progress
