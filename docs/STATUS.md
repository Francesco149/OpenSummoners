...
```
█░░░░░░░░░░░░░░░░░░░  7.4% touched   (7.4% host-tested, 9.7% of code bytes)
```

| status      | count | what it means                                          |
|-------------|------:|--------------------------------------------------------|
| tested      |   118 | ported + module covered by the host unit suite       |
| ported      |     3 | reimplemented in src/, no host test for that module  |
| **touched** | **121** | tested + ported (FUN_ provenance ref in src/)    |
| unported    |  1637 | exists in engine, never referenced from src/         |
