...
```
██░░░░░░░░░░░░░░░░░░  9.2% touched   (9.2% host-tested, 10.3% of code bytes)
```

| status      | count | what it means                                          |
|-------------|------:|--------------------------------------------------------|
| tested      |   144 | ported + module covered by the host unit suite       |
| ported      |     6 | reimplemented in src/, no host test for that module  |
| **touched** | **150** | tested + ported (FUN_ provenance ref in src/)    |
| unported    |  1608 | exists in engine, never referenced from src/         |
...
Code-byte coverage (10.3% of engine-proper bytes) is the truer progress
