...
|-------------|------:|--------------------------------------------------------|
| tested      |   201 | ported + module covered by the host unit suite       |
| ported      |     5 | reimplemented in src/, no host test for that module  |
| **touched** | **206** | tested + ported (FUN_ provenance ref in src/)    |
| unported    |  1552 | exists in engine, never referenced from src/         |
