...
```
██░░░░░░░░░░░░░░░░░░  11.5% touched   (11.5% host-tested, 13.0% of code bytes)
```

| status      | count | what it means                                          |
|-------------|------:|--------------------------------------------------------|
| tested      |   179 | ported + module covered by the host unit suite       |
| ported      |     5 | reimplemented in src/, no host test for that module  |
| **touched** | **184** | tested + ported (FUN_ provenance ref in src/)    |
| unported    |  1574 | exists in engine, never referenced from src/         |
