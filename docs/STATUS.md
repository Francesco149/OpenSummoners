...
```
██░░░░░░░░░░░░░░░░░░  11.2% touched   (11.2% host-tested, 12.1% of code bytes)
```

| status      | count | what it means                                          |
|-------------|------:|--------------------------------------------------------|
| tested      |   175 | ported + module covered by the host unit suite       |
| ported      |     5 | reimplemented in src/, no host test for that module  |
| **touched** | **180** | tested + ported (FUN_ provenance ref in src/)    |
| unported    |  1578 | exists in engine, never referenced from src/         |
...
Code-byte coverage (12.1% of engine-proper bytes) is the truer progress
