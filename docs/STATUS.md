...
```
██░░░░░░░░░░░░░░░░░░  9.7% touched   (9.7% host-tested, 10.9% of code bytes)
```

| status      | count | what it means                                          |
|-------------|------:|--------------------------------------------------------|
| tested      |   151 | ported + module covered by the host unit suite       |
| ported      |     6 | reimplemented in src/, no host test for that module  |
| **touched** | **157** | tested + ported (FUN_ provenance ref in src/)    |
| unported    |  1601 | exists in engine, never referenced from src/         |
...
Code-byte coverage (10.9% of engine-proper bytes) is the truer progress
