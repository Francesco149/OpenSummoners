...
int test_map_decode_1b58b_shape0(void)
{
    ...
    map_decode_cell(&f.m, g, 2, 3, 0, dims_1x1, NULL);
...
int test_map_decode_1b58b_shape2(void)
{
    ...
    map_decode_cell(&f.m, g, 5, 5, 0, dims_1x1, NULL);
...
int test_map_decode_1b58d_shape2_blend(void)
{
    ...
    map_decode_cell(&f.m, g, 1, 1, 0, dims_1x1, NULL);
...
int test_map_decode_1b58f_shape0_base_only(void)
{
    ...
    map_decode_cell(&f.m, g, 3, 3, 0, dims_1x1, NULL);
...
int test_map_decode_1b58f_shape12_fg(void)
{
    ...
    map_decode_cell(&f.m, g, 4, 4, 0, dims_1x1, NULL);
...
int test_map_decode_29ff4_shape14_z1(void)
{
    ...
    map_decode_cell(&f.m, g, 6, 6, 1, dims_1x1, NULL);
...
int test_map_decode_single_tile_arms(void)
{
    ...
    map_decode_cell(&f.m, g, 2, 2, 0, dims_1x1, NULL);
    ...
    map_decode_cell(&f.m, g, 4, 4, 1, dims_1x1, NULL);
...
int test_map_decode_full_small(void)
{
    ...
    map_decode(&f.m, g, dims_1x1, NULL);
